                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Add Post</strong> Cheques</h3>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                                                                            
                                                    <select class="form-control select" name="accNo">
                                                        <?php 
                                                        ...
                                                        while($row = $result->fetch_assoc()) {
                                                    ?>
                                                        <option><?php echo $row['account'] ?></option>
                                                    <?php
                                                        }
                                                    ?>
                                                    </select>
                                                    <span class="help-block">Select the account number here</span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">                                        
                                                <label class="col-md-3 control-label">Today Date</label>
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                        <input type="text" name="todayDate" class="form-control datepicker" value="2017-01-01">                                            
                                                    </div>
                            ...
                            <?php
                                ...
                                $sql="INSERT INTO post_chq (bank,accNo,chqNo,amount,name,chqDate,todayDate) VALUES ('$bank','$accNo','$chqNo','$amount','$name','$chqDate','$todayDate')";
